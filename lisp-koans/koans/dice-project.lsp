...
(defmethod get-values ((object dice-set))
  (loop for i from 1 to (slot-value object 'size)
        collect (slot-value object 'value)))

(defmethod roll (how-many (object dice-set))
  (incf (slot-value object 'value))
  (setf (slot-value object 'size) how-many)
  (when (> (slot-value object 'value) 6)
    (setf (slot-value object 'value) 1))
